...
llama_context::llama_context(
    ...
    cparams.n_expert_cache_bytes = params.n_expert_cache_bytes;
...
void llama_context::sched_reserve() {
    ...
    ggml_backend_sched_set_expert_cache_size(sched.get(), cparams.n_expert_cache_bytes);
